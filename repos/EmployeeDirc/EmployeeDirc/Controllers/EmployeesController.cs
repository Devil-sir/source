...
namespace EmployeeDirc.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> MaxSalary()
        {
            List<Employee> myList =await _context.Employees.ToListAsync();
            ViewBag.MaxSal = myList.Select(e => e.salary).Max();
